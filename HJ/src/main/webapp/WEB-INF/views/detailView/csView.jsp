...
<body>
	...
	<main>
		...
		<article id="article">
				<div class="sub">
					<div class="back">
						<a href="${pageContext.request.contextPath}/.com/cs"><i class="fa-solid fa-arrow-left-long"></i> 뒤로</a>
					</div>
				</div>
				<div class="item">
					<div class="info">
						...
						<div class="left">
							<div class="button">
								<c:if test="${countDown != 0}">
									<a href="${pageContext.request.contextPath}/.com/cs/${countDown}">이전 글</a>
								</c:if>
							</div>
						</div>
						<div class="center">
							<div class="button">
								<a href="${pageContext.request.contextPath}/.com/cs">목록</a>
							</div>
						</div>
						<div class="right">
							<div class="button">
								<c:if test="${countUp != 0}">
									<a href="${pageContext.request.contextPath}/.com/cs/${countUp}">다음 글</a>
								</c:if>
							</div>
						</div>
					</div>
					...
					<div class="listAndEdit">
						...
						<div class="right">
							...
							<div class="button">
								<a href="${pageContext.request.contextPath}/.com/updateBoard/${csData.boardNum}">수정</a>
							</div>
