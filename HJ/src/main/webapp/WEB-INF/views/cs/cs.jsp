...
<body>
	...
	<main>
			...
			<c:if test="${listcount > 0}">
				...
				<div class="center-block">
			 		<ul class="pagination justify-content-center">
			 			...
			 			<c:if test="${page > 1}">
			 				<li class="prev">
			 					<a class="pageNumber" href="cs?page=${page-1}"><i class="fa fa-chevron-left" aria-hidden="true"></i>;</a>
			 				</li>
			 			</c:if>
			 			...
			 			<c:forEach var="a" begin="${startpage}" end="${endpage}">
			 				...
			 				<c:if test="${a != page}">
			 					<li class="number">
			 						<a class="pageNumber" href="cs?page=${a}">${a}</a>
			 					</li>
			 				</c:if>
			 			</c:forEach>
			 			...
			 			<c:if test="${page < maxpage}">
			 				<li class="next">
			 					<a class="pageNumber" href="cs?page=${page+1}"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
			 				</li>
			 			</c:if>
			 		</ul>
			 	</div>
		...
		<div class="searchArea">
			<div></div>
			<div>
				<form action="cs" method="post" id="cs_Form">
					<div class="search">
			...
			<div class="write">
				<button type="button" id="csWbtn" class="csWbtn">글쓰기</button>
			</div>
		</div>
	</main>
</body>
