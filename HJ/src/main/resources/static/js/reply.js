$(function () {
            ...
            success: function (rdata) {
                if (rdata.listcount > 0) {
                    ...
                    $(rdata.list).each(function () {
                        ...
                        output += "                        <button type='button' class='updateBtn'><i class='fa-regular fa-pen-to-square'></i>수정</button>";
                        output += "                    </div>";
                        ...
                        $('.update').click(function () {				//댓글 수정 버튼 클릭 이벤트
							...
							$(this).closest('.update').addClass('cancel').removeClass('update');
							$('.updateBtn').text('취소');
							
							$('.cancel').click(function () {
								$(this).closest('#updateReply').remove();
								
								$('.cancel').addClass('update').removeClass('cancel');
								$('.updateBtn').text('수정');
	...
	$('.submit').click(function () {
		...
		const buttonText = $('.submit').text().trim();
